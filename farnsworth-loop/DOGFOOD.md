...
|--------|------|---------|--------|----------------------------------------------------------------------------------|--------------------------|
| D-0005 | sev2 | infra   | [in-progress] @rob 2026-06-15T03:03:13Z run:fl-fix-D0005 | fl-bench scores a *completed* claude-family call as FAIL on nonzero exit (haiku, glm-5.1) | docs/dogfood/D-0005.md |
